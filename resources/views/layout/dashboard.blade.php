...
<script type="text/javascript">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
       <span class="brand-text font-weight-light">BPJS KESEHATAN</span>
    </a>
...
{{--
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <br>
        <li class="nav-item">
          <a href='/dashboarddatakaryawan' class="nav-link">
        ...
        <br>
        <li class="nav-item">
            <a href='/dashboarddataruangan' class="nav-link">
        ...
        <li class="nav-item">
            ...
            <a href='/dashboarddatakeadaangedung' class="nav-link">
